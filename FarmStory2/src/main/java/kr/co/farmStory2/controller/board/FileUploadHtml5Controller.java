...
@WebServlet("/fileUploadHtml5.do")
public class FileUploadHtml5Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		logger.info("FileUploadHtml5Controller doPost...");
		//파일정보
	    String sFileInfo = "";
	    //파일명을 받는다 - 일반 원본파일명
	    ...
	    if (cnt == 0) {
	        ...
	        //파일 기본경로 _ 상세경로
	        String filePath = dftFilePath + "/smartEditor/inputImage" + File.separator;
	        ...
	        req.getSession(false).setAttribute("realFileNm", realFileNm);
	        // 정보 출력
	        sFileInfo += "&bNewLine=true";    
	        sFileInfo += "&sFileName=" + filename;    
	        sFileInfo += "&sFileURL=" + req.getContextPath() + "/smartEditor/inputImage/"+realFileNm;
