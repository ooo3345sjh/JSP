    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/' + contextRoot + '/fileUploadHtml5.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/" + contextRoot + '/fileUpload.do',	//샘플 URL입니다.
 	        sCallback : "/" + contextRoot + '/smartEditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
